 ...
 *
 */
	Configure::write('Routing.prefixes', array('commander'));
 ...
 */
	Configure::write('Security.salt', '$2a$sumitkohlisumitkohli0$');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '$2a$sumitkohlisumitkohli0$');
